...
$\\\cos\theta =\frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{v}||\cdot ||\overrightharpoon{w}||}$
...
$\\\theta = \cos^{-1}(\frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{v}||\cdot ||\overrightharpoon{w}||})$

<font color ='green'>So let's do another quick example and then we'll teach you the real stuff for today's lesson: </font>

## <ins>Example 2</ins>
if $\overrightharpoon{v} = 2\mathbf{i}-\mathbf{j}$, and $\overrightharpoon{w} = 3\mathbf{i}+4\mathbf{j}$, what is the angle between $\overrightharpoon{v}$ and $\overrightharpoon{w}$?

<font color ='blue'>$\Rightarrow \overrightharpoon{v}\cdot\overrightharpoon{w}=(2)(3)+(-1)(4) = 2$</font>
...
<font color ='blue'>$\Rightarrow ||\overrightharpoon{v}|| = \sqrt{2^2 + (-1)^2} =\sqrt{5}\\$
and $||\overrightharpoon{w}|| = \sqrt{3^3 + 4^2} = \sqrt{25} = 5$</font>
...
* <font color ='blue'>Def: <ins>Vector projection</ins> - the vector $\overrightharpoon{v}f$ creates in the direction of $\overrightharpoon{w}$</font>
...
<font color ='blue'>$\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}$</font>

<font color ='blue'>The magnitude of $\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}$ is called scalar or component projection.</font>

<font color='green'> Just so we're clear on the notation, what would this notation mean? </font>
<font color = 'blue'>$\mathbb{proj}_{\overrightharpoon{a}}\overrightharpoon{b}$</font>
...
<font color ='blue'>$\cos\theta = \frac{||\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}||}{||\overrightharpoon{v}||}$</font>
...
<font color ='blue'>$||\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}|| = \cos\theta \cdot||\overrightharpoon{v}||$</font>
...
<font color ='blue'>$\\\cos\theta =\frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{v}||\cdot ||\overrightharpoon{w}||}$</font>

<font color ='green'>If we plug this in for cosine theta here, we then have</font>

<font color ='blue'>$||\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}|| =\frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{v}||\cdot ||\overrightharpoon{w}||}\cdot||\overrightharpoon{v}||$</font>

<font color ='green'>Do you see anything we can eliminate here? Yes, the magnitude of v. So our final formula becomes: </font>

<font color ='blue'>$||\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}|| =\frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{w}||}$</font>
...
<font color ='blue'>So, $\Rightarrow\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v} = \frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{w}||}\cdot \frac{\overrightharpoon{w}}{||\overrightharpoon{w}||}$ </font>

<font color ='green'>which simplifies to</font>

<font color ='blue'>$\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v} = \frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{w}||^2}\cdot \overrightharpoon{w}$</font>

<font color ='green'>Easy, right? Alright alright enough definitions and formulas, let's try an example: </font>

## <ins>Example 3</ins>
if $\overrightharpoon{v}= 2\mathbf{i}+4\mathbf{j}$, and $\overrightharpoon{w} = -2\mathbf{i}+6\mathbf{j}$, what is $\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}$?

<font color ='blue'>$\mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v} = \frac{\overrightharpoon{v} \cdot \overrightharpoon{w}}{||\overrightharpoon{w}||^2}\cdot \overrightharpoon{w} = \frac{(2\mathbf{i}+4\mathbf{j})\cdot(-2\mathbf{i}+6\mathbf{j})}{\sqrt{(-2)^2+6^2}^2}\cdot(-2\mathbf{i}+6\mathbf{j})$</font>
...
$||\overrightharpoon{w}|| = \sqrt{(-2)^2+6^2}\\ \Rightarrow \sqrt{40}$
...
<font color ='blue'>$v_2 = v - v_1$, where $v_1 = \mathbb{proj}_{\overrightharpoon{w}}\overrightharpoon{v}$</font> easy!

So, let's try an example with our previous vecctors : 

## <ins>Example 3.2</ins>
$\overrightharpoon{v}= 2\mathbf{i}+4\mathbf{j}$, and $\overrightharpoon{w} = -2\mathbf{i}+6\mathbf{j}$ find $\overrightharpoon{v_1}$ and $\overrightharpoon{v_2}$ where v2 is the vector orthogonal to v's projection.
...
<font color ='blue'>So then $\\\overrightharpoon{v_2} = (2\mathbf{i}+4\mathbf{j})-(-\mathbf{i}+ 3\mathbf{j}) \\ \Rightarrow 3\mathbf{i}+\mathbf{j}$</font>
...
<font color ='blue'>w = (magnitude of force)x(Distance) (or how much you actually moved it) = $\overrightharpoon{F}\cdot\mathbb{d} = ||\overrightharpoon{F}||\cdot||\overrightharpoon{d}||\cdot\cos\theta$</font>
